...
![Understanding Reasoning LLMs](substack-img-002.png)
...
![From GPT-2 to gpt-oss: Analyzing the Architectural Advances](substack-img-028.png)
...
![From GPT-2 to gpt-oss: Analyzing the Architectural Advances](substack-img-035.png)
...
![Understanding and Coding Self-Attention, Multi-Head Attention, Causal-Attention, and Cross-Attention in LLMs](substack-img-044.png)
...
![A Technical Tour of the DeepSeek Models from V3 to V3.2](substack-img-054.png)
...
![Beyond Standard LLMs](substack-img-058.jpg)
...
![Understanding the 4 Main Approaches to LLM Evaluation (From Scratch)](substack-img-069.png)
...
![Build a Large Language Model (From Scratch)](substack-img-074.webp "Build a Large Language Model (From Scratch)")

...
![Figure 1: Model of the NVIDIA Hopper H100 GPU](aleksagordic-img-001.png)
...
![Figure 2: Memory hierarchy of the H100 (SXM5) GPU](aleksagordic-img-002.png)
...
![Figure 3: H100 SXM5 BF16 speed-of-light derivation](aleksagordic-img-003.png)
...
![Figure 4: Power throttling reduces clock frequency and lowers the effective “speed of light”](aleksagordic-img-004.png)
...
![Figure 5: CUDA Programming Model: threads, warps, blocks, clusters, grids](aleksagordic-img-005.png)
...
![Figure 6: CUDA's built-in variables: how threads know where they are](aleksagordic-img-006.png)
...
![Figure 7: Inside a DRAM cell: transistor + capacitor, wordline + bitline](aleksagordic-img-007.png)
...
![Figure 8: GMEM model](aleksagordic-img-008.png)
...
![Figure 9: Effect of access pattern in GMEM](aleksagordic-img-009.png)
...
![Figure 10: SMEM model](aleksagordic-img-010.png)
...
![Figure 11: SMEM: good vs. bad access patterns](aleksagordic-img-011.png)
...
![Figure 12: SMEM: multicasting (served in a single cycle)](aleksagordic-img-012.png)
...
![Figure 13: L1 cache model](aleksagordic-img-013.png)

Figure 13: L1 cache model

Let's go one level deeper and look at the tag stage and data stage in detail:

![Figure 14: Breakdown of k-way set-associative cache organization](aleksagordic-img-014.png)
...
![Figure 15: CUDA compilation flow: from CUDA C++ → PTX → SASS](aleksagordic-img-015.png)
...
![Figure 16: Naive CPU matmul example](aleksagordic-img-016.png)
...
![Figure 17: Tile quantization](aleksagordic-img-017.png)
...
![Figure 18: Thread organization in naive matmul kernel](aleksagordic-img-018.png)

Figure 18: Thread organization in naive matmul kernel

And the matmul logic itself looks like this:

![Figure 19: Naive matmul kernel](aleksagordic-img-019.png)
...
![Figure 20: Nsight Compute: Occupancy, Waves info](aleksagordic-img-020.png)
...
![Figure 21: Wave quantization](aleksagordic-img-021.png)
...
![Figure 22: PTX code corresponding to naive matmul CUDA kernel](aleksagordic-img-022.png)
...
![Figure 23: SASS code corresponding to naive matmul CUDA kernel](aleksagordic-img-023.png)
...
![Figure 24: New logical organization of row2 and col2 variables](aleksagordic-img-024.png)

Figure 24: New logical organization of row2 and col2 variables

And here's what the modified kernel does now:

![Figure 25: Naive kernel with uncoalesced GMEM access](aleksagordic-img-025.png)
...
![Figure 26: Roofline model](aleksagordic-img-026.png)
...
![Figure 27: Matmul as a sum of partial outer products](aleksagordic-img-027.png)
...
![Figure 28: Dot product is equivalent to a sum of partial dot products](aleksagordic-img-028.png)
...
![Figure 29: Arithmetic intensity improves when each thread computes multiple outputs and when tiles approach a square shape](aleksagordic-img-029.png)
...
![Figure 30: High-level structure of the warp-tiling algorithm, also referred to as block tiling.](aleksagordic-img-030.png)
...
![Figure 31: Loading a chunk of B (GMEM) into Bs (SMEM)](aleksagordic-img-031.png)
...
![Figure 32: Loading a chunk of A (GMEM) into As (SMEM)](aleksagordic-img-032.png)
...
![Figure 33: Performing matmul between As and Bs as a series of thread-level outer products (warp-tiling + thread-tiling).](aleksagordic-img-033.png)
...
![Figure 34: We keep the same high-level structure of the warp-tiling algorithm (block-tiling).](aleksagordic-img-034.png)
...
![Figure 35: Swizzling example](aleksagordic-img-035.png)
...
![Figure 36: No bank conflicts when loading rows or columns](aleksagordic-img-036.png)
...
![Figure 37: Swizzle function intuition](aleksagordic-img-037.png)
...
![Figure 38: Connecting the swizzle function to the matrix swizzle example](aleksagordic-img-038.png)
...
![Figure 39: Why doing four 64x16 @ 16x64 wgmma calls is equivalent to doing a 64x64 @ 64x64 matmul](aleksagordic-img-039.png)
...
![Figure 40: We are wasting TMA and TC cycles - we can do better](aleksagordic-img-040.png)
...
![Figure 41: More efficient TC/TMA pipeline: producer warp-group streams tiles into a circular buffer; consumer warp-group drains tiles into tensor cores.](aleksagordic-img-041.png)
...
![Figure 42: Two consumer warp groups let us grow the tile from 128x128 -> 128x256 without register spills](aleksagordic-img-042.png)
...
![Figure 43: Persistent kernels: overlap the output store with incoming loads by launching one long-lived block per SM that processes many tiles.](aleksagordic-img-043.png)
...
![Figure 47: Using thread block clusters to reduce the number of L2/GMEM loads.](aleksagordic-img-047.png)
...
11.  Lecture 44: NVIDIA Profiling [https://www.youtube.com/watch?v=F\_BazucyCMw&ab\_channel=GPUMODE](https://www.youtube.com/watch?v=F_BazucyCMw&ab_channel=GPUMODE)
12.  [https://github.com/siboehm/SGEMM\_CUDA/](https://github.com/siboehm/SGEMM_CUDA/)
...
14.  Efficient GEMM in CUDA [https://github.com/NVIDIA/cutlass/blob/b0e09d7cd371eded41f7c1e057caf1593c27ba55/media/docs/efficient\_gemm.md](https://github.com/NVIDIA/cutlass/blob/b0e09d7cd371eded41f7c1e057caf1593c27ba55/media/docs/efficient_gemm.md)

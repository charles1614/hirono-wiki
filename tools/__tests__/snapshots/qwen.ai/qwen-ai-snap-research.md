...
> 原文链接: https://qwen.ai/research
> 主题元信息: 4 item(s) on the listing at fetch time. Order: site default (newest first).

---

## 1. [Qwen-Scope: Decoding Intelligence, Unleashing Potential](https://qwen.ai/research/qwen-scope)

![Qwen-Scope: Decoding Intelligence, Unleashing Potential](qwen-ai-snap-research-images/qwen-ai-research-01.png)
...
## 2. [FlashQLA: CP-/Bwd-Friendly Fused Linear Attention Kernels for GDN](https://qwen.ai/research/flashqla)

![FlashQLA: CP-/Bwd-Friendly Fused Linear Attention Kernels for GDN](qwen-ai-snap-research-images/qwen-ai-research-02.png)

**Open-Source · 2026/04/28**

Following the release of Qwen3-Next, Gated Delta Network (GDN) has become the workhorse attention layer across the Qwen family — from Qwen3-Next-80B-A3B all the way to the subsequent Qwen3.5 / Qwen3.6 series. As models scale to 397A17B / 122A10B / 35B / 27B and context...

## 3. [Qwen3.6-27B: Flagship-Level Coding in a 27B Dense Model](https://qwen.ai/research/qwen3.6-27b)

![Qwen3.6-27B: Flagship-Level Coding in a 27B Dense Model](qwen-ai-snap-research-images/qwen-ai-research-03.png)
...
## 4. [Qwen3.6-Max-Preview: Smarter, Sharper, Still Evolving](https://qwen.ai/research/qwen3.6-max-preview)

![Qwen3.6-Max-Preview: Smarter, Sharper, Still Evolving](qwen-ai-snap-research-images/qwen-ai-research-04.png)

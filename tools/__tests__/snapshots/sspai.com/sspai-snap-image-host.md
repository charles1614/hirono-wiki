# 从零开始搭建你的免费图床系统 （Cloudflare R2 + WebP Cloud + PicGo） - 少数派

> 原文链接: https://sspai.com/post/90170
...
![OAS6b8BCNofkKdx8Ujjc5n1xncc](sspai-snap-image-host-images/sspai-com-img-007.jpg)
...
![SYRgbiBKHoujFxx86OJcRgELn5e](sspai-snap-image-host-images/sspai-com-img-008.png)
...
![EzfBb4jsKonMwMxS6s1ceVqTnae](sspai-snap-image-host-images/sspai-com-img-009.png)

开通 R2 服务后，点击右上角「创建存储桶」按钮进行创建。

![DPvrbIwheo7mIvxB0K6cRp19nVb](sspai-snap-image-host-images/sspai-com-img-010.png)
...
![DTXvbOxaqo5BfdxroyvcFs4dnue](sspai-snap-image-host-images/sspai-com-img-011.png)
...
![ZGCgbtc2RoEBU0xnrTGcIAbwnfc](sspai-snap-image-host-images/sspai-com-img-012.png)

首先我们需要打开「R2.dev 子域」，这是为了后续访问图片时需要的公网地址，点击「允许访问」，并按照提示输入「allow」即可开启。

![G1iLbdJ0joB68qx3Bl2cj5H8nTQ](sspai-snap-image-host-images/sspai-com-img-013.png)
...
![Z67NbjAK9oYBIAxaFZncFWClnRe](sspai-snap-image-host-images/sspai-com-img-014.png)

输入自己想绑定的域名，如 `yu-r2-test.pseudoyu.com`，点击继续。

![MsGXbzaHIoOovvxmnVCc0BMgnvb](sspai-snap-image-host-images/sspai-com-img-015.png)

![TdO0bptycoXFWyxGewucqrDGnie](sspai-snap-image-host-images/sspai-com-img-016.png)

连接域，并等待 DNS 解析生效即可。

![SyTVbUjWrop0eSxdZ4lcf8NWnkc](sspai-snap-image-host-images/sspai-com-img-017.png)

完成后 bucket 状态处「公共 URL 访问」显示“已允许”，且「域」显示为我们刚自定义的域名即配置成功。

#### 配置 Bucket 访问 API

![APacbU5pWoT4jzxHALgcZtwKnHe](sspai-snap-image-host-images/sspai-com-img-018.png)
...
![M7U9b8iWmoPIqSxC2gjcSGisnnc](sspai-snap-image-host-images/sspai-com-img-019.png)

![QeiDbUeweofzOsxanjsc91v6nPx](sspai-snap-image-host-images/sspai-com-img-020.png)

回到 R2 主页面，点击右上角「管理 R2 API 令牌」，进入后点击「创建 API 令牌」。

![QYF2bnVgVoJ3WIx3WJ9corX7ndd](sspai-snap-image-host-images/sspai-com-img-021.png)

输入令牌名称，「权限」选择“对象读和写”并将此 API 指定之前所创建的 Bucket，这样最小化权限也保障数据安全，其余选项保持默认即可。

![SRzmbDEfLonpwqxazvIcTUL1nsc](sspai-snap-image-host-images/sspai-com-img-022.png)
...
![FMwabhdhGojlwtxiIyScRHcVnCf](sspai-snap-image-host-images/sspai-com-img-023.png)

在「插件设置」中选择安装，「图床设置」中就新增了 Amazon S3 选项。点击进入配置选项。

![QVQrbPbu8oYQ8txPpNVc6QjOnvd](sspai-snap-image-host-images/sspai-com-img-024.png)
...
![JYLsbRdF4omhFPxGgsJcxQTjnrb](sspai-snap-image-host-images/sspai-com-img-025.png)

完成上述配置后，我们就可以在「上传区」直接拖入文件进行图片上传了，如上传后显示无误则为配置成功，生成的链接会自动在系统剪贴板中，直接在需要的地方粘贴即可。

![RA1sbFL1LoYb5wx7jp2cS8srnyh](sspai-snap-image-host-images/sspai-com-img-026.png)
...
![RlJibimTdoEoWXxFkbvclcPknbb](sspai-snap-image-host-images/sspai-com-img-027.png)
...
![M4vbbrAu8oaYSPxlnQscEsu6npb](sspai-snap-image-host-images/sspai-com-img-028.png)
...
![G3pybPmywoY6hZxEnscccgdjnXe](sspai-snap-image-host-images/sspai-com-img-029.png)

首先通过 GitHub 授权登录 [WebP Cloud](https://sspai.com/link?target=https%3A%2F%2Fdashboard.webp.se%2F) 平台。

![XTC4bMTC7oXDy3xEDZCcIhp9nbe](sspai-snap-image-host-images/sspai-com-img-030.png)

页面非常直观，主要显示了当前 Plan 下的 Free Quota 和额外 Quota 的数据，以及一些用量统计。

点击「Create Proxy」按钮可以添加配置。

![OTuNbicfooC964xif2Tcz2kZnGg](sspai-snap-image-host-images/sspai-com-img-031.png)
...
![Vre4bBcQgoT1ydxnoYTcK3BMn8b](sspai-snap-image-host-images/sspai-com-img-032.png)

图中 Basic info 部分「Visitor」下显示的以 `xxx.webp.li` 格式即为我们的代理地址。

例如我们之前通过 PicGo 上传到 R2 的文件 [yu-r2-test.pseudoyu.com/new_mbp_setup.jpg](https://sspai.com/link?target=https%3A%2F%2Fyu-r2-test.pseudoyu.com%2Fnew_mbp_setup.jpg) 则可以用 [dc84642.webp.li/new_mbp_setup.jpg](https://sspai.com/link?target=https%3A%2F%2Fdc84642.webp.li%2Fnew_mbp_setup.jpg) 这一链接进行访问。
...
![FTbzbPw7robMWLxI8V4croDenHh](sspai-snap-image-host-images/sspai-com-img-033.png)
...
![XfaRb3vT2o4MCLxvf06cirbfnwc](sspai-snap-image-host-images/sspai-com-img-034.png)

我博客的日访问量大概在 300-500 visits 左右，再加上一些 RSS 订阅和爬虫的流量，根据 WebP Cloud 统计测算来看，平日的请求大概在 4000-5000 次，发博文当天会有 10000+。

![NSyNbZ4UcogqrWxBLi7cXk2PnPg](sspai-snap-image-host-images/sspai-com-img-035.png)

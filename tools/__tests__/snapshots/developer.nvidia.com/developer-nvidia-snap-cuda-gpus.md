...
> 原文链接: https://developer.nvidia.com/cuda/gpus
> Find the compute capability for your GPU.

---
## CUDA GPU Compute Capability

[Compute capability](https://docs.nvidia.com/cuda/cuda-programming-guide/05-appendices/compute-capabilities.html) (CC) defines the hardware features and supported instructions for each NVIDIA GPU architecture. Find the compute capability for your GPU in the table below.
For legacy GPUs, refer to [Legacy CUDA GPU Compute Capability](https://developer.nvidia.com/cuda/gpus/legacy).
...
[Download CUDA Toolkit](https://developer.nvidia.com/cuda-downloads)[Documentation](https://docs.nvidia.com/cuda/)

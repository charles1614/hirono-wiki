...
| --- | --- | --- |
| [01-overview](01-overview.md) | Architecture Overview | Directory structure, layer diagram |
| [02-tensor-fundamentals](02-tensor-fundamentals.md) | Core Tensor System | TensorImpl, Storage, ScalarType |
| [03-dispatch-system](03-dispatch-system.md) | Operator Dispatch | DispatchKey, Dispatcher |
| [04-aten-operators](04-aten-operators.md) | ATen Operations | native\_functions.yaml, TensorIterator |
| [05-autograd-engine](05-autograd-engine.md) | Automatic Differentiation | Engine, Node, Edge |
| [06-python-cpp-bindings](06-python-cpp-bindings.md) | Python-C++ Integration | pybind11, Module.cpp |
| [07-torchscript-jit](07-torchscript-jit.md) | TorchScript JIT | IR, Graph, passes |
| [08-torch-compile](08-torch-compile.md) | Modern Compiler Stack | Dynamo, Inductor, FX |
| [09-nn-module-system](09-nn-module-system.md) | Neural Network Modules | nn.Module, hooks |
| [10-distributed-training](10-distributed-training.md) | Distributed Systems | DDP, FSDP, DTensor |
| [11-data-loading](11-data-loading.md) | Data Pipeline | DataLoader, Dataset |
| [12-quantization](12-quantization.md) | Quantization Framework | Observers, FakeQuantize |
| [13-export-deployment](13-export-deployment.md) | Model Export | torch.export, ONNX |
| [14-build-testing](14-build-testing.md) | Build and Testing | CMake, TestCase |
| [15-evolution-roadmap](15-evolution-roadmap.md) | Evolution and Roadmap | Recent changes, future |
...
| **TORCH\_LIBRARY** | Macro for registering operators with the dispatcher |
...
*This documentation is auto-generated and may not reflect the latest changes. For authoritative information, consult the source code.*

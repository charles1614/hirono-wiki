...
[![Shell Script](linux-do-claude-code-proxy-images/linuxdo-img-001.svg)](https://www.gnu.org/software/bash/)
![License](linux-do-claude-code-proxy-images/linuxdo-img-002.svg)
...
上一个帖子：[平平无奇- TBAI_claude code 实现自由](https://linux.do/t/topic/761806)
...
![image](linux-do-claude-code-proxy-images/linuxdo-img-003.png)
请问一下这个错误是为什么啊

## #19 @bifang · 2025-07-03

![image](linux-do-claude-code-proxy-images/linuxdo-img-004.jpg)
用上了 :tieba\_003:
...
\[quote=“Tingxifa, post:1, topic:762693, username:Ling_Anthony”]
...
![image](linux-do-claude-code-proxy-images/linuxdo-img-005.png)
...
![image](linux-do-claude-code-proxy-images/linuxdo-img-006.png)

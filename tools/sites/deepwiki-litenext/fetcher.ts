...
export function extractDeepwikiLitenextContent(url: string): DeepwikiLitenextContent {
  ...
  try {
    ...
    return {
      contentHtml: "", mermaidSources: [], title: "",
      error: `extractDeepwikiLitenextContent threw: ${e instanceof Error ? e.message : e}`,
    };
  } finally {

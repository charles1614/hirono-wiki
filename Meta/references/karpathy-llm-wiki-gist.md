...
(rev ac46de1, retrieved 2026-05-11).

This wiki adopts the spirit (LLM-as-laborer, human-as-curator,
persistent compounding artifact, file-based markdown over RAG) but

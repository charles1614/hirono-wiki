...
- The Gemma family extends with Gemma 4 (Apr 2026 Google release): E2B/E4B small-on-device variants featuring [[Cross-Layer Attention]] (KV sharing) and [[Per-Layer Embeddings]], a 26B [[MoE]] variant for efficient local inference, and a 31B dense flagship. E2B uses MQA + [[Sliding Window Attention]] in a 4:1 pattern. — [[2026-05-17-recent-developments-in-llm-architectures]]

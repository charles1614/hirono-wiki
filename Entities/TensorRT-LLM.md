...
- Tair KVCache Manager (Alibaba Cloud, Dec 2025) provides a unified global KVCache management interface across SGLang, vLLM, RTP-LLM, and TensorRT-LLM, with storage backend abstraction covering 3FS and other systems; enables cross-instance KVCache reuse without engine-specific integration. — [[2025-12-14-阿里云-tair-联手-sglang-共建-hicache-构建面向-智能体式推]]

...
- Composer 2 (Cursor) selected Kimi K2.5 via internal evaluations measuring codebase perplexity, coding knowledge, and state tracking; the selection was also driven by inference performance considerations; Composer 2 achieves CursorBench 61.3 vs Kimi K2.5's 36.0 baseline, validating the continued pretraining + RL stack. — [[2026-03-26-composer]]

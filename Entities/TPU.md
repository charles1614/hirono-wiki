...
- Detailed TCO/architectural analysis: TPUv7 shows 45–56% training cost advantage vs NVIDIA H100/Blackwell (FP8 MFU 40% vs GPU 30%, contested per MegaScale BF16 parity data); GB200/GB300 reverses the Prefill cost advantage by 35–50% via FP4; 3D Torus wins at 1k–20k chip scale for regular LLM training but fails on MoE (irregular all-to-all). TPU v8 competitive moat narrows: GB200/TPUv7 training TCO gap 1.52× shrinks to VR200/TPUv8p 1.23×; HBM bandwidth per-TCO gap from 1.32× to 1.10×. — [[2026-01-15-tpu-vs-gpu-全面技术对比-谁拥有-ai-算力最优解]]

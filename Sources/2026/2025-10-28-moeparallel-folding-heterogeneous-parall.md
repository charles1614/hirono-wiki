...
- **Figures 4-9** (supporting, ablation curves): per-knob ablations of TP, EP, CP, DP, PP across Mixtral and Qwen2. Underlying support for the 49.3% / 39.0% MFU headlines. Read the captions for which axis is being varied.

...
> 发布时间: 2025-09-10T12:28:11
> 原文链接: https://huggingface.co/blog/smollm3

---
> **Authors:** [Elie Bakouch](/eliebak) (@eliebak), [Carlos Miguel Patiño](/cmpatino) (@cmpatino), [Anton Lozhkov](/anton-l) (@anton-l), [Edward Beeching](/edbeeching) (@edbeeching), [Aymeric Roucher](/m-ric) (@m-ric), [Nouamane Tazi](/nouamanetazi) (@nouamanetazi), [Aksel Joonas Reedi](/akseljoonas) (@akseljoonas), [Guilherme Penedo](/guipenedo) (@guipenedo), [Hynek Kydlicek](/hynky) (@hynky), [Clémentine Fourrier](/clefourrier) (@clefourrier), [Nathan Habib](/SaylorTwift) (@SaylorTwift), [Kashif Rasul](/kashif) (@kashif), [Quentin Gallouédec](/qgallouedec) (@qgallouedec), [Hugo Larcher](/hlarcher) (@hlarcher), [Mathieu Morlon](/glutamatt) (@glutamatt), [Joshua](/Xenova) (@Xenova), [Vaibhav Srivastav](/reach-vb) (@reach-vb), [Xuan-Son Nguyen](/ngxson) (@ngxson), [Colin Raffel](/craffel) (@craffel), [Lewis Tunstall](/lewtun) (@lewtun), [Loubna Ben Allal](/loubnabnl) (@loubnabnl), [Leandro von Werra](/lvwerra) (@lvwerra), [Thomas Wolf](/thomwolf) (@thomwolf)

This article is also available in Chinese [简体中文](/blog/zh/smollm3).
...
![](08-image-20-2824-29.png)

[Anchored Preference Optimization](https://arxiv.org/abs/2408.06266) (APO) is a variant of [Direct Preference Optimization](https://arxiv.org/abs/2305.18290) (DPO) that provides a more stable optimization objective. In DPO, the reward function r\_θ(x,y) measures the log-ratio of the probability of the sequence during training compared to the model at the start of training, the reference model:

![](09-image-20-2825-29.png)

Here β controls how much the model being optimized can change relative to the reference model. The DPO loss optimizes triplets of prompts x, chosen y\_w and rejected y\_l responses:

![](10-image-20-2826-29.png)

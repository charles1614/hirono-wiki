...
<figure class="image text-center">
  <img src="02-01_moe_layer.png" alt="MoE layer in LSTM">
...
<figure class="image text-center">
  <img src="03-02_moe_block.png" alt="MoE Transformer Encoder">
...
<figure class="image text-center">
  <img src="04-03_switch_layer.png" alt="Switch Transformer Layer">
...
<figure class="image text-center">
  <img src="05-04_switch_table.png" alt="Table shows that selective precision does not degrade quality.">
...
<figure class="image text-center">
  <img src="06-05_experts_learning.png" alt="Experts specialize in some token groups">
...
<figure class="image text-center">
  <img src="07-06_superglue_curves.png" alt="Fine-tuning learning curves">
...
<figure class="image text-center">
  <img src="08-07_superglue_bars.png" alt="Only updating the non MoE layers works well in fine-tuning">
...
<figure class="image text-center">
  <img src="09-08_superglue_dense_vs_sparse.png" alt="Table comparing fine-tuning batch size and learning rate between dense and sparse models.">
...
<figure class="image text-center">
  <img src="11-10_parallelism.png" alt="Image illustrating model, expert, and data prallelism">
...
<figure class="image text-center">
  <img src="12-11_expert_matmuls.png" alt="Matrix multiplication optimized for block-sparse operations.">

...
![Sebastian Raschka, PhD's avatar](images/img_002.jpeg)
...
![Understanding Reasoning LLMs](images/img_004.png)
...
![From GPT-2 to gpt-oss: Analyzing the Architectural Advances](images/img_030.png)
...
This is because the query (Q), key (K), and value (V) are _n_\-by-_d_ matrices, where _d_ is the embedding dimension (a hyperparameter) and _n_ is the sequence length (i.e., the number of tokens).

You can find more details on attention in my other article:

![Understanding and Coding Self-Attention, Multi-Head Attention, Causal-Attention, and Cross-Attention in LLMs](images/img_045.png)
...
Figure 40: Illustration of the quadratic cost in attention due to sequence length _n_.
...
![A Technical Tour of the DeepSeek Models from V3 to V3.2](images/img_055.png)
...
![Beyond Standard LLMs](images/img_059.jpeg)
...
![A Dream of Spring for Open-Weight LLMs: 10 Architectures from Jan-Feb 2026](images/img_069.png)
...
![Understanding the 4 Main Approaches to LLM Evaluation (From Scratch)](images/img_071.png)
...
_Build a Large Language Model (From Scratch) is now available on [Amazon](https://amzn.to/4fqvn0D). Build a Reasoning Model (From Scratch) is in [Early Access at Manning](https://mng.bz/Nwr7)._
...
![Aaron Ip's avatar](images/img_077.jpeg)![Rajesh Chukka's avatar](images/img_078.jpeg)![Dan Thorin's avatar](images/img_079.png)![Aayush Shah's avatar](images/img_080.png)![KimSia Sim's avatar](images/img_081.jpeg)

...
> 原文链接: https://lmsys.org/blog/2026-01-21-novita-glm4/
...
-   [TL;DR](#tldr)
-   [How We Implemented Core Production Optimizations for GLM-MoE](#how-we-implemented-core-production-optimizations-for-glm-moe)
-   [1\. Shared Experts Fusion](#1-shared-experts-fusion)
-   [2\. Qknorm Fusion](#2-qknorm-fusion)
-   [3\. Async Transfer](#3-async-transfer)
-   [Production Benchmark Results](#production-benchmark-results)
-   [Benchmark configuration](#benchmark-configuration)
-   [Results](#results)
-   [Suffix decoding](#suffix-decoding)
-   [Background: The Inference Bottleneck in Agentic Coding](#background-the-inference-bottleneck-in-agentic-coding)
-   [How Suffix Decoding Works](#how-suffix-decoding-works)
-   [Data Validation: Output Pattern Repetition Analysis](#data-validation-output-pattern-repetition-analysis)
-   [Performance Comparison](#performance-comparison)
-   [Conclusion](#conclusion)
-   [How to Reproduce](#how-to-reproduce)
-   [Core Optimization Flags (SGLang Runtime)](#core-optimization-flags-sglang-runtime)
-   [Speculative decoding configuration (agentic coding workload)](#speculative-decoding-configuration-agentic-coding-workload)
-   [Suffix Decoding configuration (optional)](#suffix-decoding-configuration-optional)
-   [References](#references)

# Optimizing GLM4-MoE for Production: 65% Faster TTFT with SGLang

Novita AIJanuary 21, 2026
...
![Shared Experts Fusion](01-shared-experts-fusion.png)
...
![Qknorm Fusion](02-qknorm-fusion.png)
...
![Async Transfer Schedule](03-async-transfer-schedule.png)
...
![Async Transfer TTFT Gains](04-async-transfer-ttft.png)
...
![Benchmark TTFT](05-benchmark-ttft.png) ![Benchmark TPOT](06-benchmark-tpot.png)
...
![How Suffix Decoding Works](07-suffix-decoding.png)
...
Addresses compute efficiency in MoE models
...
Optimizes data movement in disaggregated deployments

Suffix Decoding

Leverages pattern repetition for speculative decoding for agentic coding

Most components are already merged upstream or undergoing integration; feel free to check them out on the SGLang repo.

## How to Reproduce

Only the key performance-relevant parameters are shown here. Full launch scripts (baseline vs optimized), benchmark harness, and profiling traces are published in GitHub: [novitalabs/sglang (glm\_suffix branch)](https://github.com/novitalabs/sglang/tree/glm_suffix).

...
**DeepSeek V3 / R1 (shared, 671B)** (`https://hirono-wiki.litenext.digital/raindrop/sebastianraschka.com/2026-04-03-llm-architecture-gallery/images/deepseek-v3-r1-671-billion.webp`)
...
**DeepSeek V4-Pro** (`https://hirono-wiki.litenext.digital/raindrop/sebastianraschka.com/2026-04-03-llm-architecture-gallery/images/deepseek-v4-pro.webp`)
...
**Kimi K2 (1T)** (`https://hirono-wiki.litenext.digital/raindrop/sebastianraschka.com/2026-04-03-llm-architecture-gallery/images/kimi-k2-1-trillion.webp`)
...
**GPT-OSS 120B** (`https://hirono-wiki.litenext.digital/raindrop/sebastianraschka.com/2026-04-03-llm-architecture-gallery/images/gpt-oss-120b.webp`)

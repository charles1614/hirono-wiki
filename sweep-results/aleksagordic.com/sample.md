...
![Figure 1: Model of the NVIDIA Hopper H100 GPU](www-aleksagordic-com-img-001.png)
...
![Figure 2: Memory hierarchy of the H100 (SXM5) GPU](www-aleksagordic-com-img-002.png)
...
![Figure 3: H100 SXM5 BF16 speed-of-light derivation](www-aleksagordic-com-img-003.png)
...
![Figure 4: Power throttling reduces clock frequency and lowers the effective “speed of light”](www-aleksagordic-com-img-004.png)
...
![Figure 5: CUDA Programming Model: threads, warps, blocks, clusters, grids](www-aleksagordic-com-img-005.png)
...
![Figure 6: CUDA's built-in variables: how threads know where they are](www-aleksagordic-com-img-006.png)
...
![Figure 7: Inside a DRAM cell: transistor + capacitor, wordline + bitline](www-aleksagordic-com-img-007.png)
...
![Figure 8: GMEM model](www-aleksagordic-com-img-008.png)
...
![Figure 9: Effect of access pattern in GMEM](www-aleksagordic-com-img-009.png)
...
![Figure 10: SMEM model](www-aleksagordic-com-img-010.png)
...
![Figure 11: SMEM: good vs. bad access patterns](www-aleksagordic-com-img-011.png)
...
![Figure 12: SMEM: multicasting (served in a single cycle)](www-aleksagordic-com-img-012.png)
...
![Figure 13: L1 cache model](www-aleksagordic-com-img-013.png)

Figure 13: L1 cache model

Let's go one level deeper and look at the tag stage and data stage in detail:

![Figure 14: Breakdown of k-way set-associative cache organization](www-aleksagordic-com-img-014.png)
...
![Figure 15: CUDA compilation flow: from CUDA C++ → PTX → SASS](www-aleksagordic-com-img-015.png)
...
![Figure 16: Naive CPU matmul example](www-aleksagordic-com-img-016.png)
...
![Figure 17: Tile quantization](www-aleksagordic-com-img-017.png)
...
![Figure 18: Thread organization in naive matmul kernel](www-aleksagordic-com-img-018.png)

Figure 18: Thread organization in naive matmul kernel

And the matmul logic itself looks like this:

![Figure 19: Naive matmul kernel](www-aleksagordic-com-img-019.png)
...
![Figure 20: Nsight Compute: Occupancy, Waves info](www-aleksagordic-com-img-020.png)
...
![Figure 21: Wave quantization](www-aleksagordic-com-img-021.png)
...
![Figure 22: PTX code corresponding to naive matmul CUDA kernel](www-aleksagordic-com-img-022.png)
...
![Figure 23: SASS code corresponding to naive matmul CUDA kernel](www-aleksagordic-com-img-023.png)
...
![Figure 24: New logical organization of row2 and col2 variables](www-aleksagordic-com-img-024.png)

Figure 24: New logical organization of row2 and col2 variables

And here's what the modified kernel does now:

![Figure 25: Naive kernel with uncoalesced GMEM access](www-aleksagordic-com-img-025.png)
...
![Figure 26: Roofline model](www-aleksagordic-com-img-026.png)
...
![Figure 27: Matmul as a sum of partial outer products](www-aleksagordic-com-img-027.png)
...
![Figure 28: Dot product is equivalent to a sum of partial dot products](www-aleksagordic-com-img-028.png)
...
![Figure 29: Arithmetic intensity improves when each thread computes multiple outputs and when tiles approach a square shape](www-aleksagordic-com-img-029.png)
...
![Figure 30: High-level structure of the warp-tiling algorithm, also referred to as block tiling.](www-aleksagordic-com-img-030.png)
...
![Figure 31: Loading a chunk of B (GMEM) into Bs (SMEM)](www-aleksagordic-com-img-031.png)
...
![Figure 32: Loading a chunk of A (GMEM) into As (SMEM)](www-aleksagordic-com-img-032.png)
...
![Figure 33: Performing matmul between As and Bs as a series of thread-level outer products (warp-tiling + thread-tiling).](www-aleksagordic-com-img-033.png)
...
![Figure 34: We keep the same high-level structure of the warp-tiling algorithm (block-tiling).](www-aleksagordic-com-img-034.png)
...
![Figure 35: Swizzling example](www-aleksagordic-com-img-035.png)
...
![Figure 36: No bank conflicts when loading rows or columns](www-aleksagordic-com-img-036.png)
...
![Figure 37: Swizzle function intuition](www-aleksagordic-com-img-037.png)
...
![Figure 38: Connecting the swizzle function to the matrix swizzle example](www-aleksagordic-com-img-038.png)
...
![Figure 39: Why doing four 64x16 @ 16x64 wgmma calls is equivalent to doing a 64x64 @ 64x64 matmul](www-aleksagordic-com-img-039.png)
...
![Figure 40: We are wasting TMA and TC cycles - we can do better](www-aleksagordic-com-img-040.png)
...
![Figure 41: More efficient TC/TMA pipeline: producer warp-group streams tiles into a circular buffer; consumer warp-group drains tiles into tensor cores.](www-aleksagordic-com-img-041.png)
...
![Figure 42: Two consumer warp groups let us grow the tile from 128x128 -> 128x256 without register spills](www-aleksagordic-com-img-042.png)
...
![Figure 43: Persistent kernels: overlap the output store with incoming loads by launching one long-lived block per SM that processes many tiles.](www-aleksagordic-com-img-043.png)
...
![Figure 44: Naïve schedule](www-aleksagordic-com-img-044.png)

Figure 44: Naïve schedule

Can we do better? Yes—by making the schedule cache-aware:

![Figure 45: Block-wise cache-aware schedule](www-aleksagordic-com-img-045.png)

Figure 45: Block-wise cache-aware schedule

But can we do even better? Surprisingly, yes—by using a space-filling curve:

![Figure 46: Hilbert-curve schedule](www-aleksagordic-com-img-046.png)
...
![Figure 47: Using thread block clusters to reduce the number of L2/GMEM loads.](www-aleksagordic-com-img-047.png)

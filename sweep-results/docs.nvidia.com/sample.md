# Installation Guide — Nsight Systems
...
### Requirements for x86\_64 and Arm SBSA Targets on Linux
...
### Requirements for x86\_64 Targets on Windows
...
The *prod\_debug\_extra* overlay is required to enable Nsight Systems in safety environment.

...
Table of contents（No content yet）
...
2.1 Encoder-only嵌入模型

2.2 Encoder-decoder通用模型

2.3 Non-causal Decoder-only生成模型

2.4 Causal Decoder-only模型
